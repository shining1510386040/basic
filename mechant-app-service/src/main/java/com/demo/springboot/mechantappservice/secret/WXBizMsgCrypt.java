...
public class WXBizMsgCrypt {
     ...
     * </ol>
     *
     * @param replyMsg  待加密的字符串：例如：username=zhangsan&age=24
     * @param timeStamp 时间戳，可以自己生成，也可以用URL参数的timestamp
     * @param nonce     随机串，可以自己生成，也可以用URL参数的nonce
     * @return 加密后的可以直接回复用户的密文，包括msg_signature（消息签名）, timestamp（时间戳）, nonce, encrypt（消息密文）的json格式的字符串
     * @throws AesException 执行失败，请查看该异常的错误码和具体的错误信息
     */
     ...
     * </ol>
     *
     * @param msgSignature 消息签名串，对应URL参数的msg_signature
