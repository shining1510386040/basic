package com.demo.springboot.shardingspherewithspringboot.config.generator;
...
public class MybatisPlusCodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        // 代码输出项目地址
        param.put("projectPath", "D:\\IdeaProjects\\basic\\shardingsphere-with-springboot");
        // 作者
        param.put("author", "Wenyi Cao");
        param.put("url", "localhost:3306/ds0");
        param.put("driverName", "com.mysql.jdbc.Driver");
        param.put("username", "root");
        param.put("password", "root");
        // 顶层包结构
        param.put("parent", "com.demo.springboot.shardingspherewithspringboot");
        // 生成的mapper包名
        ...
        // shiro所需表
//        String[] tables = {"tbl_op_licence", "op_sys_db_map","tbl_op_user","res_recycle_task","his_tbl_op_organization","tbl_op_domain"};
    ...
    public static void generator(Map<String, String> param, String[] tablse) {
        ...
        // jdbc:postgresql://pgm-bp171kc49558n43ixo.pg.rds.aliyuncs.com:1921/ccoa?currentSchema=ccoa&useUnicode=true&characterEncoding=utf-8&serverTimezone=GMT
        dsc.setUrl("jdbc:mysql://" + param.get("url") + "?useUnicode=true&characterEncoding=utf-8&serverTimezone=GMT");
        dsc.setDriverName(param.get("driverName"));
        dsc.setUsername(param.get("username"));
        dsc.setPassword(param.get("password"));
//        // pg库默认是public命名空间，此处需指定为自己的命名空间ccoa
//        dsc.setSchemaName("ccoa");
