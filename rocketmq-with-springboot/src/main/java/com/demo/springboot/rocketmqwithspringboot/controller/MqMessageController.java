...
import com.demo.springboot.rocketmqwithspringboot.config.SendCallbackListener;
import com.demo.springboot.rocketmqwithspringboot.entity.OrderStep;
import com.demo.springboot.rocketmqwithspringboot.utils.ListSplitter;
...
public class MqMessageController {
    ...
    public ServiceResult pushMessage(@RequestParam("id") int id) {
        ...
        ServiceResult msg = new ServiceResult();
        // 解析发送结果
        if (sendResult.getSendStatus() == SendStatus.SEND_OK) {
            msg.setData(sendResult.getMsgId() + " : " + sendResult.getSendStatus());
        }
        return msg;
    }
    ...
    public ServiceResult pushAsyncMessage(@RequestParam("id") int id) {
    ...
    public ServiceResult pushOneWayMessage(@RequestParam("id") int id) {
    ...
    public ServiceResult pushSequeueMessage(@RequestParam("id") int id) {
    ...
    public ServiceResult pushDelayMessage(@RequestParam("id") int id) {
    ...
    public ServiceResult pushBatchMessage(@RequestParam("id") int id) {
    ...
    public ServiceResult pushSqlMessage(@RequestParam("id") int id) {
    ...
    public ServiceResult pushTransactionMessage(@RequestParam("id") int id) {
        ...
        TransactionSendResult transactionSendResult = rocketMQTemplate.
                sendMessageInTransaction("txProducerGroup", syncTag, message, null);
