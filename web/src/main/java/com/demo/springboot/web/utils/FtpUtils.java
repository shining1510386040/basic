...
//        FtpUtils ftp = new FtpUtils("172.18.62.111", 21, "admin", "admin");
//        ftp.initFtpClient();
//////         文件路径写为用户建立时 指定的目录
////        // 适用于Linux下搭建的ftp服务器、windows不适合； 目录分隔符的原因
//        ftp.uploadFile("/ftpFiles", "vue笔记.txt", "C:\\Users\\Lenovo\\Desktop\\vue笔记.txt");
//
////        boolean b = ftp.existFile("cloudcc 业务中台.png");
////         ftp.downloadFile("/home/ftpFile", "cloudcc 业务中台.png", "D://");
////        ftp.deleteFile("/home/ftpFile", "123.png");
//        System.out.println("ok");
////        testUpLoadFromDisk("/work/data");

        FTPClient ftpClient = FtpUtils.getFTPClient("172.18.62.111", "admin", "123", 21);
        String fileRemotePath = "D:\\FTPShare\\ftpFiles";
        String fileLocalPath = "C:\\Users\\Lenovo\\Desktop\\vue笔记.txt";
        // 1.切换工作目录
        ftpClient.changeWorkingDirectory(fileRemotePath);
        //
        ftpClient.enterLocalActiveMode();
        // 原始文件的流
        InputStream in = new FileInputStream(fileLocalPath);
        boolean b = ftpClient.storeFile(fileRemotePath + "vue笔记.txt", in);
        System.out.println("============>>ftp 上传：" + b);
    ...
    public static String testUpLoadFromDisk(String file) {
        ...
        String ftpHost = "192.168.8.116";
        String ftpUserName = "uftp";
        String ftpPassword = "123";
        int ftpPort = 21;
        String ftpPath = "/home/uftp";
